                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                        ...
                        <li class="nav-item dropdown py-3">
                            <a class="nav-link text-white dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><strong>Actions</strong></a>
                        ...
                        <li class="nav-item py-3">
                            <a class="nav-link text-white" href="contact.php"><strong>Contact Us</strong></a>
                        </li>
                    </ul>
                 </div>
            </div>

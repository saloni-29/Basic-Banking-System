...
<head>
    ...
    <class class="welcome">
        <h2>
            <img src="images/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>We are here to help you !</strong> <img
                src="images/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
